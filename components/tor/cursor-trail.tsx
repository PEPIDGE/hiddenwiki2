...
export function CursorTrail() {
  ...
  useEffect(() => {
    ...
    const onMove = (e: MouseEvent) => {
      ...
      const isInteractive =
        el?.closest("a, button, [role='button'], [tabindex], input, textarea") !== null
      ...
      if (isInteractive !== isHoverRef.current) {
        ...
        if (ringRef.current) {
          ...
          ringRef.current.style.transform = `translate(${e.clientX - 14}px, ${e.clientY - 14}px) scale(${
            isInteractive ? 1.5 : 1
          })`
        }
      }
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          pointerEvents: "none",
          zIndex: 9992,
          transition: "opacity 0.15s, transform 0.12s linear",
          opacity: 0.2,
        }}
      />
    </>
